...
public class ProcessingFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.caseapply_processing_layout, container, false);

        ListView listView = view.findViewById(R.id.listViewProcessing);

        caseList = getCaseList();
        listView.setAdapter(new ProcessingAdapter(getActivity(), caseList));
        return view;
    }
    private class ProcessingAdapter extends BaseAdapter {
        ...
        public ProcessingAdapter(Context context, List<Case> caseList) {
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            if (view == null) {
                ...
                view = layoutInflater.inflate(R.layout.processinglistview_item,viewGroup, false);
            }

            Case caseItem = caseList.get(position);

            TextView tvCaseName =
                    view.findViewById(R.id.processingListView_caseName);
            tvCaseName.setText(String.valueOf(caseItem.getCasename()));

            TextView tvCaseContent =
                    view.findViewById(R.id.processingListView_caseContent);
